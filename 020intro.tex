...
\noindent\textbf{Length Bias} is the phonomenon of a policy to favor a shorter trajectory as compared to a longer one for equal or even lesser rewards. This makes it hard to train the policy for longer and more complex queries.
...
\noindent\textbf{Language Bias} is the due to the frequennt occurance of some inputs to the API which biases the policy to predict them. For example, {\em dontcare}, or null, is seen very often in the dataset as it is the default.
